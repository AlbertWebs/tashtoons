    ...
    <div class="container-fluid sb1">
        <div class="row">
            ...
            <div class="col-md-2 col-sm-3 col-xs-6 sb1-1">
                ...
                <a href="{{url('/')}}/admin/home" class="logo"><img src="{{url('/')}}/uploads/logo/{{$SiteSettings->logo_two}}" alt="{{$SiteSettings->sitename}}" />
                </a>
            </div>
            <!--== SEARCH ==-->
            ...
            <div class="col-md-2 tab-hide">
                <div class="top-not-cen">
                    ...
                    <a title="Blog Post" class='waves-effect btn-noti' href='#'><i class="fa fa-commenting-o" aria-hidden="true"></i><span>1</span></a>
                    <a title="Messages" class='waves-effect btn-noti' href='#'><i class="fa fa-envelope-o" aria-hidden="true"></i><span>2</span></a>
