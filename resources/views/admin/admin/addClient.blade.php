        ...
        <div class="sb2-2">
            <div class="sb2-2-2">
                <ul>
                    ...
                    <li class="active-bre"><a href="#"> Add New Client</a>
                    </li>
                    <li class="page-back"><a href="{{url('/')}}/admin/clients"><i class="fa fa-backward" aria-hidden="true"></i> All Clients</a>
                    </li>
                </ul>
            ...
            <div class="sb2-2-add-blog sb2-2-1">
                <div class="box-inn-sp">
                    ...
                    <div class="bor">
                        <form method="POST" action="{{url('/')}}/admin/add_Client" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <textarea required name="link" class="materialize-textarea"></textarea>
