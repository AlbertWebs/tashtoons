                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box-inn-sp">
                            ...
                            <div class="tab-inn">
                                <form method="post"  enctype="multipart/form-data" action="{{url('/')}}/admin/edit_About">
                                    {{csrf_field()}}
                                    <div class="row">
                                    ...
                                    <input autocomplete="off" type="hidden" name="what_we_do" value="{{$Setting->what_we_do}}" class="validate">
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <textarea required id="article-ckeditor" name="about" class="materialilze-textarea" placeholder="content">{{$Setting->about}}</textarea>
                                        </div>
                                    </div><br><br>
